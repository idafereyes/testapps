...
@Component
@Scope("prototype")
public class FlushTrueHangupTrueTran implements Serializable {
	...
	public Output test() {
		...
		wd.setText("Probamos un output programático con flush catchHangup a true. Con transición tirada.");		
		ai.setWording(wd);
