...
@Component
@Scope("prototype")
public class FlushTrueHangupFalseTran implements Serializable {
	...
	public Output test() {
					...
					wd.setText("Probamos un output programático con flush a true y catchHangup a false. Con transición tirada.");		
					ai.setWording(wd);
